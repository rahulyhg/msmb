			  ...
			  <tr>
				 <form name="thisForm" method="post" onSubmit="return validate(this);">
						...
						<div><img src="images/vdot.jpg" width="596" height="1" border="0" style="margin-top:0px"/></div>-->
							...
							<ul>	
								<li><a href="www.shaadi.com" class="faq_inner1" target="_blank">www.Maa Shakti Marriage Bureau</a></li>
								<li><a href="www.newassamesematrimony.com" class="faq_inner1" target="_blank">www.newassamesematrimony.com</a> </li>
								<li><a href="www.newbengalimatrimony.com" class="faq_inner1" target="_blank">www.newbengalimatrimony.com</a> </li>
								<li><a href="www.newgujaratimatrimony.com" class="faq_inner1" target="_blank">www.newgujaratimatrimony.com</a> </li>
								<li><a href="www.newhindimatrimony.com" class="faq_inner1" target="_blank">www.newhindimatrimony.com</a> </li>
								<li><a href="www.newkannadamatrimony.com" class="faq_inner1" target="_blank">www.newkannadamatrimony.com</a> </li>
								<li><a href="www.newkeralamatrimony.com" class="faq_inner1" target="_blank">www.newkeralamatrimony.com</a> </li>
								<li><a href="www.newmarathimatrimony.com" class="faq_inner1" target="_blank">www.newmarathimatrimony.com</a></li>
								<li><a href="www.newmarwadimatrimony.com" class="faq_inner1" target="_blank">www.newmarwadimatrimony.com</a> </li>
								<li><a href="www.neworiyamatrimony.com" class="faq_inner1" target="_blank">www.neworiyamatrimony.com</a> </li>
								<li><a href="www.newpunjabimatrimony.com" class="faq_inner1" target="_blank">www.newpunjabimatrimony.com</a></li>
								<li><a href="www.newsindhimatrimony.com" class="faq_inner1" target="_blank">www.newsindhimatrimony.com</a></li>
								<li><a href="www.newtamilmatrimony.com" class="faq_inner1" target="_blank">www.newtamilmatrimony.com</a></li>
								<li><a href="www.newtelugumatrimony.com" class="faq_inner1" target="_blank">www.newtelugumatrimony.com</a></li>
								<li><a href="www.newurdumatrimony.com" class="faq_inner1" target="_blank">www.newurdumatrimony.com</a></li>
							</ul>
