...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td width="168" height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <!--DWLayoutTable-->
                    <tr>
                      <td width="90" height="20" valign="top">LONG:</td>
                            <td width="78" valign="top"><? echo $longi.".".$longi_m; ?></td>
                            </tr>
                    </table>                  </td>
                      </tr>
                <tr>
                  <td height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="90" height="20" valign="top">LAT:</td>
                              <td width="78" valign="top"><? echo $lati.".".$lati_m; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                <tr>
                  <td height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="90" height="20" valign="top">LONG DIR:</td>
                              <td width="78" valign="top"><? echo $longi_d; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                <tr>
                  <td height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="90" height="20" valign="top">LAT DIR:</td>
                              <td width="78" valign="top"><? echo $lati_d; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                <tr>
                  <td height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="90" height="20" valign="top">TIMEZONE:</td>
                              <td width="78" valign="top"><? echo $t_zone; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                <tr>
                  <td height="20" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <!--DWLayoutTable-->
                            <tr>
                              <td width="90" height="20" valign="top">TIMEZONE DIR:</td>
                              <td width="78" valign="top"><? echo $longi_d; ?></td>
                            </tr>
                          </table></td>
                      </tr>
