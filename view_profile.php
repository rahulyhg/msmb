																	...
																	if (mysql_num_rows($resPhoto) > 0) {
																		...
																		<?  
																				break;
																					...
																					if ($memPhoto[approve]) { ?>
																					<script>							
																						photos["<?=$i?>"] = "userthumbnail/<?=$memPhoto[thumbnail]?>";
																					</script>																			
																				<?	} else { ?>
																					<script>																			
																						photos["<?=$i?>"] = "userimages/<?=$memPhoto[photo]?>";
																					</script>	
																				<?	}																														
																				$i++;
																			}		
											  ...
											  <tr>
												<td class="tbdr" bgcolor="#f3fae6" align="center">
													...
													<?
													  ...
													  <tr>
														<td class="intxt" width="124" colspan="3" align="center">--</td>
														 </tr>
