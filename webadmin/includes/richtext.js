...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		//	document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'post_button_image.gif" width="25" height="24" alt="Insert Link" title="Insert Link" onClick="dlgInsertLink1(\'' + rte + '\', \'link\')"></td>');
