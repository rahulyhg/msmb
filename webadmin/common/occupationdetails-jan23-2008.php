							...
							<tr bgcolor="#FFFFFF">
								...
								<td>
									<table class="story"><tr><td>Married</td><td>
									<select name="no_of_Brothers" class="agebox">
										<option value="0">0</option>
										<option value="1">1</option>
										<option value="2">2</option>
										<option value="3">3</option>
									...
									<? if ($user[no_of_Brothers]) {?>
									<script language="javascript">
										document.thisForm.no_of_Brothers.value = "<?=$user[no_of_Brothers]?>";
									</script>	
									<? } ?>									
									</td><td>UnMarried</td><td>
							...
							<tr class="tblContent">
								...
								<td>
									...
									<td align="center"><input type="text" name="areaCode" class="txtboxage" value="<?=$phone[1]?>" maxlength="4" /></td>
									<td align="center"><input type="text" name="phoneNumber" class="txtbox" value="<?=$phone[2]?>" maxlength="8" /></td>
									</tr>
									</table>
								</td>						 
							</tr>
