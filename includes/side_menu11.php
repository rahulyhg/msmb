...
<div style="padding-top:12px; order:#00FF00 1px solid; width:172px; float:left;">
 ...
 <?php /*?> <tr><td valign="center" height="25">&nbsp;&nbsp;&nbsp
  ...
  <tr><td height="25" bgcolor="#e68800">&nbsp;<strong style="color:#fbf7d1;">Horoscope</strong></a></td></tr> 
  <tr>
    <td><a href="<? echo $urlpath;?>astrohoro/Userhoro1.php" class="submenuinner">Generate Horoscope</a></td>
  </tr>
  <tr>
    <td><a href="<? echo $urlpath;?>astrohoro/Astro_Compare.php" class="submenuinner">Horoscope Match</a></td>
  </tr>
  <tr>
    <td><a href="<? echo $urlpath;?>astrohoro/Astro_Product.php" class="submenuinner">Horoscope Product</a></td>
  </tr>
  <?
  $select_ful="select * from horo_pay where username='$usr1' and status='Approved' and package='Full Horoscope'";
  $result_ful=mysql_query($select_ful,$link);
  $num_ful=mysql_num_rows($result_ful);
  if($num_ful!='0'){
  ?>
  <tr>
    <td><a href="../astrohoro/Full_Horoscope.php" class="submenuinner">Full Horoscope</a></td>
  </tr>
  ...
  ?>
  <?
  $select_gem="select * from horo_pay where username='$usr1' and status='Approved' and package='Gem Finder'";
  $result_gem=mysql_query($select_gem,$link);
  $num_gem=mysql_num_rows($result_gem);
  if($num_gem!='0'){
  ?>
  <tr>
    <td><a href="../astrohoro/Gem_Finder.php" class="submenuinner">Gem Finder</a></td>
  </tr>
  ...
  ?>
  <?
  $select_num="select * from horo_pay where username='$usr1' and status='Approved' and package='Numerology'";
  $result_num=mysql_query($select_num,$link);
  $num_num=mysql_num_rows($result_num);
  if($num_num!='0'){
  ?>
  <tr>
    <td><a href="../astrohoro/Numerology.php" class="submenuinner">Numerology</a></td>
  </tr>
  ...
  ?>
  <?
  $select_sup="select * from horo_pay where username='$usr1' and status='Approved' and package='Super Horoscope'";
  $result_sup=mysql_query($select_sup,$link);
  $num_sup=mysql_num_rows($result_sup);
  if($num_sup!='0'){
  ?>
  <tr>
    <td><a href="../astrohoro/Super_Horoscope.php" class="submenuinner">Super Horoscope</a></td>
  </tr>
  
  <?
  }
  ?>
  <tr><td><a href="<? echo $urlpath;?>astrohoro/Daily_Prediction.php" class="submenuinner">Daily Prediction</a></td></tr>
