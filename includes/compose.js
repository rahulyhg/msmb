	...
	function EditorInstantiate()
	{
		...
		var html = "";
		html += "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"300\">";
/*		html += "<tr>";
		...
		html += "</td>";
		html += "<td>";
		html += "<select class=\"List\" name=\"Fnt\" onchange=\"EditorOnFont(" + this.id + ", this)\">";
		html += "<option class=\"Heading\">Font</option>";
		html += "<option value=\"Tamil-Ananthi\">Tamil-Ananthi</option>";				
...
*/		
		...
		html += "<tr>";
		html += "<td>";
		html += "<iframe id=\"" + EDITOR_COMPOSITION_PREFIX + this.id + "\" width=\"420\" height=\"200\">";
		html += "</iframe>";
		html += "</td>";
		html += "</tr>";
		html += "</table>";
		...
		html += "5, 5,";
		html += "[";
		html += "\"./images/Emoticons/1.gif\",";
		html += "\"./images/Emoticons/2.gif\",";
		html += "\"./images/Emoticons/3.gif\",";
		html += "\"./images/Emoticons/4.gif\",";
		html += "\"./images/Emoticons/5.gif\",";
		html += "\"./images/Emoticons/6.gif\",";
		html += "\"./images/Emoticons/7.gif\",";
		html += "\"./images/Emoticons/8.gif\",";
		html += "\"./images/Emoticons/9.gif\",";
		html += "\"./images/Emoticons/a.gif\",";
		html += "\"./images/Emoticons/b.gif\",";
		html += "\"./images/Emoticons/c.gif\",";
		html += "\"./images/Emoticons/d.gif\",";
		html += "\"./images/Emoticons/e.gif\",";
		html += "\"./images/Emoticons/f.gif\",";
		html += "\"./images/Emoticons/g.gif\",";
		html += "\"./images/Emoticons/h.gif\",";
		html += "\"./images/Emoticons/i.gif\",";
		html += "\"./images/Emoticons/j.gif\",";
		html += "\"./images/Emoticons/k.gif\",";
		html += "\"./images/Emoticons/l.gif\",";
		html += "\"./images/Emoticons/m.gif\",";
		html += "\"images/Emoticons/n.gif\",";
		html += "\"images/Emoticons/o.gif\",";
		html += "\"images/Emoticons/p.gif\"";
		html += "],";
	...
	function EditorOnForegroundColor(id){
		...
		var color = showModalDialog("includes/ColorPicker.htm", "", "font-family:Verdana;font-size:12;dialogWidth:17em;dialogHeight:25em");
		if (color) {
	...
	function EditorOnCreateHyperlink(id){
		...
		var link = prompt("enter link location (eg. http://advanceecomsolutions.com):", anchor ? anchor.href : "http://");
		if (link && link != "http://") {
	...
	function EditorOnStartInsertSmiley(id){
		if (eval(EDITOR_IMAGE_CHOOSER_PREFIX + id).IsShowing()) {
			...
			eval(EDITOR_IMAGE_CHOOSER_PREFIX + id).Show(400,200);
		}
	}
