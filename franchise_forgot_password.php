...
if($_REQUEST['Mode']=="forgot"){
	...
	if(mysql_num_rows($res_chk)>0){
		$obj=mysql_fetch_object($res_chk);		
			...
			//$image_url="http:/www.24x7a2z.com/shaadi/ver2/images/logo.jpg";
			$mailmsg ="";
			...
			$mailmsg .= "<tr bgColor='#ffffff'>\n<td colspan=2>Dear ".$obj->franchisee_name."</td>\n</tr>\n";
			$mailmsg .= "<tr bgColor='#ffffff'>\n<td colspan='2'>Your Password Details are</td>\n</tr>\n";
			$mailmsg .= "<tr bgColor='#ffffff'>\n<td>Login ID</td><td>".$obj->franchisee_id."</td>\n</tr>\n";
			$mailmsg .= "<tr bgColor='#ffffff'>\n<td>Login Password</td><td>".$obj->franchisee_password."</td>\n</tr>\n";
			...
			$strTo= $obj->franchisee_email;					
			$strSubject = "Your Shaadi.com - World Number 1 Maa Shakti Marriage Bureau Franchise Password details";
			$strContent = $mailmsg;
			send_mail($strTo,$strFrom,$strSubject,$strContent); 		
			$_SESSION['_msg']="The password details are sent to your Email address";
			header("Location:franchise_forgot_password.php"); 
	     	die();
			

	}else{
		$_SESSION['_msg']="Sorry!!, You are not a valid Franchise.. ";
		header("Location:franchise_forgot_password.php");
     	die();
	}				
}
...
function MM_swapImage() { //v3.0
  var i,j=0,x,a=MM_swapImage.arguments; document.MM_sr=new Array; for(i=0;i<(a.length-2);i+=3)
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
	...
	function fnLogin(){
		if(isNull(document.thisForm.txtFranchiseeID,"Franchise ID/Email address")){return false;}	
	}
//-->
</script>
</head>
	  ...
	  <tr>
		...
		<td valign="top">
			...
			<table width="573" border="0" cellspacing="0" cellpadding="0" >
			  <tr>
				<td valign="top">
					<div class="titlebg"><h1 class="title">Forgot Password</h1>
					</div>
				</td>
			  </tr>
			  <tr>
			...
			<? } ?>	
			  <tr>
					   <form name="thisForm" action="franchise_forgot_password.php?Mode=forgot" method="post" onSubmit="return fnLogin();">
					    <td width="592" rowspan="4" valign="top">
						<div>
							<table cellpadding="0" width="560 " cellspacing="0" border="0" class="loginbg">
								<tr>
									<td width="223" style="padding:40px 0px 30px 20px;" valign="top">
										<table border="0" cellspacing="0" align="left"  cellpadding="0">
											...
											<tr>
											 ...
											 <tr>
											  <td height="35" colspan="2" align="right" style="padding-right:30px;"><input name="Submit" type="submit" value="Forgot password"  class="button" style="width:120px;"></td></tr>
											 <!-- <tr><td class="select" height="30" colspan="2" align="left"><font color="#FF0000">*</font> Marked fields are mandatory<br><br></td> 
										</tr>	
											 <tr>
									...
									<td valign="top"  style="padding:13px 0px 0px 0px;" align="left">
						 				<table  border="0" cellspacing="0" cellpadding="0" class="upgnow" height="222">
											<tr>
													<td valign="top" width="466" style="padding:0px 0px 0px 10px;">
