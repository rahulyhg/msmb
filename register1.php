	...
	if ($action == 'occupation') {
		...
		?>
			<script language="javascript">
				location.href = 'register3.php?action1=occupation';
			</script>
		<?
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" valign="top">
		<div style="padding:20px 12px 0px 0px;  float:left;">
		<table width="267"   border="0" cellspacing="0" cellpadding="0" >
			<tr><td><img src="images/add_left.jpg" border="0" width="268"/></td></tr>
		</table>
		</div>
		<form name="thisForm" method="post" enctype="multipart/form-data" onSubmit="return fnRegister1()">	
				<input type="hidden" name="action" value="occupation">			
			<? 
				/* Load register form with original variables */
				foreach($_REQUEST as $post_key=>$post_value) {
					if($post_key !== "action" && $post_key !== "terms" && $post_key !== "mydateHid" && $post_key !== "btnSave")	{
