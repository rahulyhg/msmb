		...
		if ($config[userinfo][id]) {
			...
			for ($i = 0; $i < count($user_ids); $i++) {
				...
				if (mysql_num_rows($res1) == 0) {
					...
					$_SESSION['msg'] = "Selected profile(s) already in your bookmark list. <a href='search.php'><b>Click here</b></a> to add bookmark.";
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td valign="top">
			<div style="padding:12px 2px 0px 0px; width:573px; float:right;" >
			<table width="573" border="0" cellspacing="0" cellpadding="0" >
			  ...
			  <tr>
						...
						<form name="thisForm" action="forward_profile.php" method="post" enctype="multipart/form-data" onSubmit="return fnForward()">	
							<input type="hidden" name="action" value="submit" />
							<input type="hidden" name="id" value="<?=$id?>"	/>
							<input type="hidden" name="mode" value="<?=$mode?>" />					
						<table border="0" width="90%" align="center" cellspacing="1" cellpadding="0" gcolor="#c0ba84">
						 <tr bgcolor="#FFFFFF"><td>
							<table width="574" border="0" lign="center" cellspacing="0" cellpadding="0" lass="probg">
							
								<!--<tr><td height="25" colspan="3" lass="forward_topbg"><h1 class="title">Forward Profile(s) to Friend</h1></td></tr>		
								<tr><td class="probdr">&nbsp;</td></tr> -->
								<tr>
									<td>
										<table width="574" cellpadding="2" cellspacing="2" class="forwardbg">
											...
											<tr>
												...
												<td><textarea name="message" onClick="this.value='';" class="txtarea"><?= $defmsg; ?></textarea></td>
											</tr>
											<tr>
