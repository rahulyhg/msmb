					  ...
					  <tr>
						<td width="10%" rowspan="6" bgcolor="#FFFFFF">
							<table width="22%" border="0" cellspacing="0" cellpadding="0">
								  <tr><td colspan="3">										
										<?
												...
												if (mysql_num_rows($resPhoto) > 0) {
													...
													while ($memPhoto = mysql_fetch_array($resPhoto)) { ?>
														...
														$resPhoto1 = Execute("select * from tbl_photo where userid = '".$_SESSION['id_user']."' and approve = 0");
										...
										<script>
											if (linkornot==0)
												document.write("<a href=\"javascript:PhotoManager('<?=$_SESSION['id_user']?>')\">")
						...
						<td  rowspan="6" bgcolor="#FFFFFF" valign="top">
							<table width="220" border="0" cellspacing="5" cellpadding="0"  class="btxt">
							  ...
							  <tr><td height="20">Member Status</td><td>:</td><td><?=preg_replace('/package/','',GetSingleField('package_name','tbl_packages','package_id',$config[userinfo][membership_type]));?></td></tr>							  
							  ...
							  <tr><td height="20">Profile Expiry on</td><td>:</td><td><? echo strftime("%d %b %Y",strtotime($config[userinfo][package_expiry_date]));?></td></tr>
...
//								$id = PartnerMatch :: GetPartnerMatch($config[userinfo][id]);
								...
								//PartnerMatch :: AddMatchingPartnerToTblMatchProfile($config[userinfo][id]);
								$id = PartnerMatch :: GetPartnerMatch($config[userinfo][id]);
															...
															<tr>
																...
																?>
																	...
																	<td align="center" width="100" style="padding:3px" align="left" valign="top">
																			...
																			<img src="images/protectedphoto.gif" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="60" height="60" onclick="window.location.href='view_member_profile.php?userid=<? echo $feature_profile[username]; ?>'">
																														
																			<? } else { 
																			if ($rsImage[approve] && $rsImage[photo]) {
																			?>
																			<img id="user<?=$feature_profile[id]?>" name="user<?=$feature_profile[id]?>" rc="userthumbnail/<?=$rsImage[thumbnail]?>" src="userthumbnail/<?=$rsImage[photo]?>" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="75" height="75" onclick="window.location.href='view_member_profile.php?userid=<? echo $feature_profile[username]; ?>'" title="<? echo $feature_profile[username]; ?>">																																		
																			<?
																				} else { 
																					if (GetSingleRecord("tbl_photo","userid",$feature_profile[id])) {																	
																					?>
																						<img id="user<?=$feature_profile[id]?>" name="user<?=$feature_profile[id]?>" rc="userthumbnail/<?=$feature_profile[thumbnail]?>" src="images/pendpicture.png" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="75" height="75" onclick="window.location.href='view_member_profile.php?userid=<? echo $feature_profile[username]; ?>'" title="<? echo $feature_profile[username]; ?>">																		
																					<?	
																					} else { ?>
																						<img id="user<?=$feature_profile[id]?>" name="user<?=$feature_profile[id]?>" rc="userthumbnail/<?=$feature_profile[thumbnail]?>" src="images/nopicture.png" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="75" height="75" onclick="window.location.href='view_member_profile.php?userid=<? echo $feature_profile[username]; ?>'" title="<? echo $feature_profile[username]; ?>">																		
																					<?
																					}
																				}	
																			} 
																...
																?>
																	<td align="center" width="100" style="padding:3px" align="left">
																		<? if ($bookmarked_profile[photo_password]) {?>
																			<img src="images/protectedphoto.gif" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="60" height="60" onclick="window.location.href='view_member_profile.php?userid=<? echo $bookmarked_profile[username]; ?>'" title="<? echo $bookmarked_profile[username]; ?>">
																		<? } else { 
																				if ($rsImage[approve] && $rsImage[photo]) {
																				?>
																				...
																				<?
																					...
																					if (GetSingleRecord("tbl_photo","userid",$feature_profile[id])) {																	
																					?>
																						<img id="user<?=$bookmarked_profile[id]?>" name="user<?=$bookmarked_profile[id]?>" rc="userthumbnail/<?=$bookmarked_profile[thumbnail]?>" src="images/pendpicture.png" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="75" height="75" onclick="window.location.href='view_member_profile.php?userid=<? echo $bookmarked_profile[username]; ?>'" title="<? echo $bookmarked_profile[username]; ?>">
																					<?	
																					} else { ?>
																						<img id="user<?=$bookmarked_profile[id]?>" name="user<?=$bookmarked_profile[id]?>" rc="userthumbnail/<?=$bookmarked_profile[thumbnail]?>" src="images/nopicture.png" hspace="5" style="cursor:pointer;border:1px solid #000000;" width="75" height="75" onclick="window.location.href='view_member_profile.php?userid=<? echo $bookmarked_profile[username]; ?>'" title="<? echo $bookmarked_profile[username]; ?>">			
																					<?
																					}
																				}	
																			} 
									...
									<table width="95%" align="center" border="0" cellspacing="0" cellpadding="0">
									  <tr>
										<td width="35%"><br>
											...
											<b class="member"><?=preg_replace('/package/','',GetSingleField('package_name','tbl_packages','package_id',$config[userinfo][membership_type]));?></b><br>
