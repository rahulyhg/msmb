  ...
  <tr>
	...
	<table width="780" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td valign="top">
			<div style="padding:12px 3px 0px 0px;  float:left;" >
					...
					<table cellpadding="0" cellspacing="0" width="561" border="0" style="border:1px solid #888349;">
						<tr> 
							<td style="padding:10px; border-right:1px solid #b2aaaa;" width="125">
									<div class="photo1" align="center">
									 ...
									 <tr>
									  ...
									  <img src="successful_stories_images/thumb_<?=$obj_success->image?>"   onMouseOut="hidefloatie('<?=$iCount ?>')" onMouseOver="javaScript:showfloatie(event,'<?=$iCount?>');" style="cursor:hand" width="120" height="88">
								</div>		
							...
							<? $fd=fopen("successful_stories/".$obj_success->file_name,"r");
							   if (filesize("successful_stories/".$obj_success->file_name))	
			...
			<tr><td height="27" bgcolor="#e48931" class="tdred" style="padding-left:5px;"><font color="#FFCC00"><? getpageNumbers1($pager->numPages,$page,"successful_stories.php","year",$_REQUEST['year'],"bride",$_REQUEST["bride"]);?> </td></tr>
			</tr>
			<tr><td>&nbsp;</td></tr>
			</table>
		   </div>
